...
import 'package:kids_mobile_app/presentation/common/di/child_injector_bloc_widget.dart';
...
import '../di/${val1}_module.dart';

class ${CLASS_NAME}Page extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChildInjectorBlocWidget<${CLASS_NAME}Bloc>(
